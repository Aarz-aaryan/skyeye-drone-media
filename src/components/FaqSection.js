...
const faqs = [
  ...
  { q: 'What is the typical turnaround time?', a: 'Most listings are delivered within 24 to 48 hours. Rush delivery is available when needed.' },
  { q: 'How do we schedule a shoot?', a: 'Send the property address, target listing date, and any shot preferences. We will confirm availability and share a shot plan.' },
